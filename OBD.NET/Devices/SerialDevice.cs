...
public abstract class SerialDevice : IDisposable
{
    ...
    private readonly BlockingCollection<QueuedCommand> _commandQueue = [];
    ...
    /// <summary>
    /// Initializes the device with a custom initialization sequence
    /// </summary>
    public virtual void CustomInitialize(List<ATCommand> customSequence)
    {
        Connection.Connect();
        CheckConnectionAndStartWorker();
    }
    ...
    /// <summary>
    /// Initializes the device asynchronously with a custom initialization sequence
    /// </summary>
    public virtual async Task CustomInitializeAsync(List<ATCommand> customSequence)
    {
        await Connection.ConnectAsync();
        CheckConnectionAndStartWorker();
    }
